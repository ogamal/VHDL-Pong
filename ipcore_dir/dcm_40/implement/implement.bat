...
xst -ifn xst.scr
move dcm_40_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\dcm_40.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm_40.ucf dcm_40_exdes

echo 'Running map'
map -timing -pr b dcm_40_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm dcm_40_exdes -w routed.ncd routed.vhd
cd ..
